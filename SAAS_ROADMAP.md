...
| ⭐ PRO | ฿149 | 25 คน | ทุกอย่างใน FREE + ระบบการเงิน, Export CSV, Backup รายวัน, Audit Log 90 วัน |
| 💎 PREMIUM | ฿299 | 50 คน | ทุกอย่างใน PRO + ระบบการเงินครบวงจร (รวมเก็บเงินแก๊ง), สรุปรายเดือน, Analytics Dashboard, Multi-Admin, Webhook Notifications, Custom Branding, Audit Log ไม่จำกัด, Priority Support |
