                            ...
                            <article key={req.id} className="rounded-token-lg border border-border-subtle bg-bg-muted p-3 shadow-token-sm">
                                ...
                                <div className="mt-3 grid grid-cols-2 gap-2">
                                    <button
                                        ...
                                        className="inline-flex min-h-11 items-center justify-center gap-1.5 rounded-token-lg border border-status-success bg-status-success-subtle px-3 py-2 text-xs font-bold text-fg-success transition-colors hover:opacity-90 disabled:opacity-50"
                                    >
                                    ...
                                    <button
                                        ...
                                        disabled={!!processingId}
                                        className="inline-flex min-h-11 items-center justify-center gap-1.5 rounded-token-lg border border-status-danger bg-status-danger-subtle px-3 py-2 text-xs font-bold text-fg-danger transition-colors hover:opacity-90 disabled:opacity-50"
                                    >
                                    ...
                                    <td className="px-4 py-3 align-middle">
                                        <div className="flex items-center justify-end gap-2">
                                            <button
                                                onClick={() => handleAction(req.id, 'APPROVE')}
                                                disabled={!!processingId}
                                                className="flex items-center justify-center gap-1.5 rounded-token-lg border border-status-success bg-status-success-subtle px-3 py-2 text-xs font-semibold text-fg-success transition-colors hover:opacity-90 disabled:opacity-50"
                                            >
                                            ...
                                            <button
                                                onClick={() => handleAction(req.id, 'REJECT')}
                                                disabled={!!processingId}
                                                className="flex items-center justify-center gap-1.5 rounded-token-lg border border-status-danger bg-status-danger-subtle px-3 py-2 text-xs font-semibold text-fg-danger transition-colors hover:opacity-90 disabled:opacity-50"
                                            >
