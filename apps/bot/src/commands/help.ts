        ...
        const embed = new EmbedBuilder()
            ...
            .addFields(
                ...
                },
                {
                    ...
                    value: 'ให้ผู้ดูแลใช้ `/setup` อีกครั้ง แล้วเลือกยศยืนยันตัวตนที่ต้องการ ระบบจะซ่อมห้องและยศให้โดยไม่ต้องสร้างแก๊งใหม่ สิทธิ์หัวหน้าแก๊งยึดจากเจ้าของเซิร์ฟเวอร์ Discord',
                },
            )
