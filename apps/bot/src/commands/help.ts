        ...
        const embed = new EmbedBuilder()
            ...
            .addFields(
                ...
                },
                {
                    ...
                    value: 'ให้ผู้ดูแลใช้ `/setup` อีกครั้ง แล้วเลือกยศคนทั่วไปและยศสมาชิกแก๊งที่ใช้จริง ระบบจะซ่อมห้องและยศให้โดยไม่ต้องสร้างแก๊งใหม่ และจะใช้ห้องเดิมที่ตั้งไว้ก่อน',
                },
            )
