        ...
        const embed = new EmbedBuilder()
            ...
            .addFields(
                ...
                },
                {
                    ...
                    value: 'ให้ผู้ดูแลใช้ `/setup` อีกครั้ง แล้วเลือกยศคนทั่วไป/ผู้เยี่ยมชมที่ต้องการ ระบบจะซ่อมห้องและยศให้โดยไม่ต้องสร้างแก๊งใหม่ และจะใช้ห้องเดิมที่ตั้งไว้ก่อน',
                },
            )
